   ...
   let objektoTipas = [];
    ...
    let val;
        ...
        if(item == 3) val = 1 * objektoTipas[3].c;
        else if(item == 4) val = 12 * objektoTipas[4].c;
    ...
    function calc_second_part(size, item) {
        ...
        if(item == 1) val = round(size * objektoTipas[1].v *12, 2) ;
        else if(item == 2) val = round(size * objektoTipas[2].v * 12, 2) ;
        else if(item == 3) val = round(32.5 * 0.0850 *12, 2) ;
        else if(item == 4) val = 1 * objektoTipas[item].v;
